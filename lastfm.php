         											...
         											<ul class="navbar-inverse dropdown-menu" style="border-radius: 6px; width:100%; margin-top:10px; padding-bottom:8px; color:white;">
           												...
           												if($method_in!=2) { echo'
           													<form class="form_member" method="post" action="lastfm.php">
																	...
																	<button type="submit" class="userButton">';} echo 'Scrobbles: '.$totalTracks; 
																	if($method_in!=2) {
																	echo '</button>
																</form>';}
																 echo '
      	     											...
      	     											if($method_in!=5) { echo'
         	  												<form class="form_member" method="post" action="lastfm.php">
																	...
																	<button type="submit" class="userButton">';} echo 'Lieblingslieder'; 
																	if($method_in==5) { 
																		echo ': '.$totaltracks;
																	}
																	echo'</button>
	           											...
	           											if($method_in!=6) { echo'
   	        												<form class="form_member" method="post" action="lastfm.php">
																	...
																	<button type="submit" class="userButton">';} echo 'Top K&uuml;nstler'; 
																	if($method_in==6) { 
																		echo ': '.$totaltracks;
																	}
																	echo'</button>
           												...
           												if($method_in!=7) { echo'
           													<form class="form_member" method="post" action="lastfm.php">
																	...
																	<button type="submit" class="userButton">';} echo 'Top Titel'; 
																	if($method_in==7) { 
																		echo ': '.$totaltracks;
																	}
																	echo'</button>
					...
					if($page<$totalPages) {
   	         		...
   	         		<td class="navfooter">
   	         			<form action="?" style="margin:0; padding:0;" method="POST">
  	 							...
  	 							echo'
  	      							<option class="option"'; if($perPage==20) {echo " selected";} echo ' value="20">20 Eintr&auml;ge Pro Seite</option>
   	     							<option class="option"'; if($perPage==40) {echo " selected";} echo ' value="40">40 Eintr&auml;ge Pro Seite</option>
   	     							<option class="option"'; if($perPage==60) {echo " selected";} echo ' value="60">60 Eintr&auml;ge Pro Seite</option>';
   	     						}
   	     						else {
  	      						echo'
  	      							<option class="option"'; if($perPage==15) {echo " selected";} echo ' value="15">15 Eintr&auml;ge Pro Seite</option>
 	       							<option class="option"'; if($perPage==25) {echo " selected";} echo ' value="25">25 Eintr&auml;ge Pro Seite</option>
  	      							<option class="option"'; if($perPage==35) {echo " selected";} echo ' value="35">35 Eintr&auml;ge Pro Seite</option>';
...
function loadDoc() {
  ...
  xhttp.onreadystatechange=function() {
    if (xhttp.readyState == 4 && xhttp.status == 200) {
      document.getElementById("1452358115_text").innerHTML = xhttp.responseText;
    }
  };
   xhttp.open("GET", "http://www.w3schools.com/ajax/demo_get.asp?t=4", true);
  xhttp.send();
}
</script>
